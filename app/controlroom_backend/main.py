...
from routers import scanner_workbench, scanner_rules, scanner_pattern_rules, scanner_aliases, scanner_report, scanner_links, scanner_rejections, scanner_reset
...
app.include_router(scanner_pattern_rules.router, prefix=_SCANNER_PREFIX, tags=["scanner"])
app.include_router(scanner_aliases.router,     prefix=_SCANNER_PREFIX, tags=["scanner"])
