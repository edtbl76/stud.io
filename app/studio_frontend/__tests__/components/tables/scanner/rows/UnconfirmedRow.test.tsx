...
describe('UnconfirmedRow', () => {
  it('renders plugin name, vendor and confidence badge', () => {
    render(<UnconfirmedRow result={baseResult} onConfirm={jest.fn()} onReject={jest.fn()} onIgnore={jest.fn()} onOverride={jest.fn()} onViewRecord={jest.fn()} />)
  ...
  it('calls onConfirm with result_id when Confirm is clicked', () => {
    ...
    render(<UnconfirmedRow result={baseResult} onConfirm={onConfirm} onReject={jest.fn()} onIgnore={jest.fn()} onOverride={jest.fn()} onViewRecord={jest.fn()} />)
  ...
  it('calls onReject with result_id when Reject is clicked', () => {
    ...
    render(<UnconfirmedRow result={baseResult} onConfirm={jest.fn()} onReject={onReject} onIgnore={jest.fn()} onOverride={jest.fn()} onViewRecord={jest.fn()} />)
  ...
  it('calls onIgnore with result_id when Ignore is clicked', () => {
    ...
    render(<UnconfirmedRow result={baseResult} onConfirm={jest.fn()} onReject={jest.fn()} onIgnore={onIgnore} onOverride={jest.fn()} onViewRecord={jest.fn()} />)
  ...
  it('renders correct confidence badge color class for low confidence', () => {
    ...
    render(<UnconfirmedRow result={lowResult} onConfirm={jest.fn()} onReject={jest.fn()} onIgnore={jest.fn()} onOverride={jest.fn()} onViewRecord={jest.fn()} />)
  ...
  it('calls onOverride with full result when Override is clicked', () => {
    ...
    render(<UnconfirmedRow result={baseResult} onConfirm={jest.fn()} onReject={jest.fn()} onIgnore={jest.fn()} onOverride={onOverride} onViewRecord={jest.fn()} />)
    fireEvent.click(screen.getByTestId('override-button-r1'))
    expect(onOverride).toHaveBeenCalledWith(baseResult)
  })

  it('calls onViewRecord with full result when row body is clicked', () => {
    const onViewRecord = jest.fn()
    render(<UnconfirmedRow result={baseResult} onConfirm={jest.fn()} onReject={jest.fn()} onIgnore={jest.fn()} onOverride={jest.fn()} onViewRecord={onViewRecord} />)
    fireEvent.click(screen.getByTestId('unconfirmed-row-view-r1'))
