...
export function StudioIllustration({ className }: Readonly<{ className?: string }>) {
  return (
    ...
    >
      ...
      <rect x="130" y="160" width="90" height="130" rx="6" fill="hsl(220 14% 18%)" stroke="hsl(220 14% 28%)" strokeWidth="1.5" />
      <circle cx="175" cy="210" r="28" fill="hsl(220 14% 10%)" stroke="hsl(220 14% 30%)" strokeWidth="1.5" />
      <circle cx="175" cy="210" r="16" fill="hsl(220 14% 22%)" />
      <circle cx="175" cy="210" r="6" fill="hsl(220 14% 30%)" />
      <rect x="158" y="258" width="34" height="12" rx="3" fill="hsl(220 14% 14%)" />
      <circle cx="175" cy="276" r="4" fill="hsl(142 70% 45%)" opacity="0.9" />

      {/* Studio monitors — right */}
      <rect x="580" y="160" width="90" height="130" rx="6" fill="hsl(220 14% 18%)" stroke="hsl(220 14% 28%)" strokeWidth="1.5" />
      <circle cx="625" cy="210" r="28" fill="hsl(220 14% 10%)" stroke="hsl(220 14% 30%)" strokeWidth="1.5" />
      <circle cx="625" cy="210" r="16" fill="hsl(220 14% 22%)" />
      <circle cx="625" cy="210" r="6" fill="hsl(220 14% 30%)" />
      <rect x="608" y="258" width="34" height="12" rx="3" fill="hsl(220 14% 14%)" />
      <circle cx="625" cy="276" r="4" fill="hsl(142 70% 45%)" opacity="0.9" />
      ...
      {['◀◀', '▶', '■', '●'].map((sym, i) => (
        <text key={sym} x={352 + i * 28} y={211} fontSize="8" fill={i === 3 ? 'hsl(0 84% 60%)' : 'hsl(220 14% 55%)'} textAnchor="middle">
          {sym}
        </text>
      ))}

      {/* Monitor stand — left */}
      <rect x="165" y="288" width="20" height="14" rx="2" fill="hsl(220 14% 16%)" />
      <rect x="150" y="299" width="50" height="4" rx="2" fill="hsl(220 14% 20%)" />

      {/* Monitor stand — right */}
      <rect x="615" y="288" width="20" height="14" rx="2" fill="hsl(220 14% 16%)" />
      <rect x="600" y="299" width="50" height="4" rx="2" fill="hsl(220 14% 20%)" />
      ...
      {[0, 1, 2, 3, 4].map((i) => (
        <g key={`rack-${i}`}>
          ...
          <circle cx="748" cy={175 + i * 27} r="2.5"
            fill={rackLedColor(i)} />
        </g>
      ))}
      ...
      {/* Ambient light glow — monitors */}
      <ellipse cx="175" cy="165" rx="60" ry="15" fill="hsl(217 91% 60%)" opacity="0.04" />
      <ellipse cx="625" cy="165" rx="60" ry="15" fill="hsl(217 91% 60%)" opacity="0.04" />
