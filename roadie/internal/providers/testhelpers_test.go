...
type fakeRunner struct {
	...
	runWithStdinFn func(ctx context.Context, stdin io.Reader, out io.Writer, name string, args ...string) error
}
...
func (f *fakeRunner) RunWithStdin(ctx context.Context, stdin io.Reader, out io.Writer, name string, args ...string) error {
	if f.runWithStdinFn != nil {
		return f.runWithStdinFn(ctx, stdin, out, name, args...)
	}
	return nil
}
